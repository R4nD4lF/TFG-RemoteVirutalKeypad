...
public class LoginServiceTestUnit {
    ...
    public void doRegisterUserForUserNameAlreadyRegistered(){
        CreateUserRequest userRequest = fixture.create(CreateUserRequest.class);
        UserModel userModel = UserModel.builder().userId(110)
                .userName(userRequest.getUsername())
                .email("test@test.com").build();

        Mockito.when(this.userRepository.findByUserName(userRequest.getUsername())).thenReturn(Optional.of(userModel));
    ...
    public void doRegisterUserSuccesfully(){
        CreateUserRequest userRequest = fixture.create(CreateUserRequest.class);
        userRequest.setEmail("my-email@gmail.com");
        userRequest.setPassword("Md83as?*asCdpe.ckdk2");
    ...
    public void doLoginUserWithWrongPassword(){
        ...
        Mockito.when(this.userRepository.findByUserName(loginRequest.getLogin())).thenReturn(Optional.of(userModel));
